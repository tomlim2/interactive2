...
// second snow start
  ...
  $(".bigsnow1").click(function(){
    ...
    // pack2
      ...
      $(".asplttqmk").addClass('asnowmvr39');
      $(".asplttrest").addClass('asnowmvr40');
      $(".asplttom").addClass('asnowmvr41');
      $(".asplttcm").addClass('asnowmvr42');
    // console.log(rand);
  });
